# -*- coding: utf-8 -*-
"""
Created on Fri Sep 18 22:02:53 2020
...
train_data = tv.datasets.ImageFolder('../Data/ants_and_bees/train', transform=pre_proc)
test_data = tv.datasets.ImageFolder('../Data/ants_and_bees/val', transform=pre_proc)
...
x_test = [x[0] for x in test_data.imgs]
...
#save metrics
file_stream = open('results/AntsVsBees.txt', 'w')
print("Model Summary\n----------\n", file=file_stream)  
