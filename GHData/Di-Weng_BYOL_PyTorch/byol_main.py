...
# parser = argparse.ArgumentParser(description='BYOL PyTorch distributed learning')
#
# parser.add_argument('--config_file', '-cfg', metavar='FILE', default='config/resnet50_2x_1.yaml', type=str, help='path to BYOL config file')
...
def main():
    ...
    with open(Path(Path(__file__).parent, 'config/resnet50_2x_1.yaml'), 'r') as f:
