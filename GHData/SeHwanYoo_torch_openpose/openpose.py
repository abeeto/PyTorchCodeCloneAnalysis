...
class Openpose(object):
    def __init__(self, arch='posenet', weights_file=None, training = True):
        ...
        if training:
            ...
            coco_train = COCO(os.path.join(params['coco_dir'], 'annotations/train_baby_keypoints.json'))
            coco_val = COCO(os.path.join(params['coco_dir'], 'annotations/test_baby_keypoints.json'))
