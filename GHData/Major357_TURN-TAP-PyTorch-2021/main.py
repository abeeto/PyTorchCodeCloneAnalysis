...
def main():
    ...
    frm_nums = pickle.load(open("./train_val_files/frm_num.pkl","rb"))

    # ground_truth_url = ("https://gist.githubusercontent.com/cabaf/ed34a35ee4443b435c36de42c4547bd7/raw/952f17b9cdc6aa4e6d696315ba75091224f5de97/thumos14_test_groundtruth.csv")
    # s = requests.get(ground_truth_url,verify=False).content
