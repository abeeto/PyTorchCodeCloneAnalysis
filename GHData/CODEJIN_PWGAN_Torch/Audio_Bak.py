...
def spectrogram(y, num_freq, hop_length, win_length, sample_rate, ref_level_db = 20, spectral_subtract= False):    
    M = _magnitude(y, num_freq, hop_length, win_length, sample_rate, spectral_subtract)
    S = _amp_to_db(M) - ref_level_db
    return _normalize(S)

def inv_spectrogram(spectrogram, num_freq, hop_length, win_length, sample_rate, ref_level_db = 20, power = 1.5, griffin_lim_iters= 60):
