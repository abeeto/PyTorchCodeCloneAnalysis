...
if __name__ == "__main__":
	if len(sys.argv)!=2:
		...
		traces_file, labeled_traces_file, profiling_index, attack_index, target_points, profiling_desync, attack_desync = read_parameters_file(sys.argv[1])

		#execute the extraction function
		extract_traces(traces_file, labeled_traces_file, profiling_index, attack_index, target_points, profiling_desync, attack_desync)
