...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/yolov3-test.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_ckpt_225.pth", help="path to weights file")
