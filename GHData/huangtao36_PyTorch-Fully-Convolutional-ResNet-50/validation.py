...
if __name__ == "__main__":
    ...
    # Basic setting
    parser.add_argument('--finetune_path', type = str, default = 'resnet50_in_rgb_epoch150_bs256.pth', \
    ...
    parser.add_argument('--baseroot', type = str, \
        default = 'C:\\Users\\Desktop\\dataset\\ILSVRC2012_val_256', \
    ...
    # Network setting
    parser.add_argument('--type', type = str, default = 'resnet', help = 'vgg | resnet')
    parser.add_argument('--sub_type', type = str, default = 'resnet50_in', help = 'sub network types of vgg | resnet')
