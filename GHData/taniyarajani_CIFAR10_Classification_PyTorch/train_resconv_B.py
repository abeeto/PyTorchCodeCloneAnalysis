...
parser.add_argument('--model', choices=['softmax', 'convnet', 'twolayernn', 'mymodel', 'resnet_conv_B'], help='which model to train/evaluate')
...
elif args.model == 'resnet_conv_B':
    # Problem 5 (multiple hidden layers, input -> hidden layers -> output)
    model = models.resnet_conv_B.Combine(args.hidden_dim, args.kernel_size, n_classes)
else:  
