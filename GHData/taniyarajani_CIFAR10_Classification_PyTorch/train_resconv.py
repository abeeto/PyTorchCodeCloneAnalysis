...
parser.add_argument('--model', choices=['softmax', 'convnet', 'twolayernn', 'mymodel', 'resnet_conv'], help='which model to train/evaluate')
...
if args.model == 'softmax':
    ...
    # Problem 5 (multiple hidden layers, input -> hidden layers -> output)
    model = models.resnet_conv.Combine(args.hidden_dim, args.kernel_size, n_classes)
else:  
