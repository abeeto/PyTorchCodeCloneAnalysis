...
parser.add_argument('--model', choices=['softmax', 'convnet', 'twolayernn', 'mymodel', 'resnet_2layer_B'], help='which model to train/evaluate')
...
elif args.model == 'resnet_2layer_B':
    # Problem 5 (multiple hidden layers, input -> hidden layers -> output)
...
# Commenting below to update parameters
