# -*- coding: utf-8 -*-
"""
Created on Sat Oct  5 12:45:39 2019
...
class Network(torch.nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs):
        ...
        self.fc1 = nn.Linear(num_inputs, 32) #64
        self.actor_linear = nn.Linear(32, num_outputs) #actor outputs = Q(s,a)
        self.critic_linear = nn.Linear(32, 1) # critic output = V(s)
