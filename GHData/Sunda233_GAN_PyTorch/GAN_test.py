...
# Adam 优化算法 Adam 是一种可以替代传统随机梯度下降过程的一阶优化算法，它能基于训练数据迭代地更新神经网络权重。
...
def train_a_gan(D_net, G_net, D_optimizer, G_optimizer, discriminator_loss, generator_loss,
    ...
    with tqdm(total=num_epochs * per_epoch_num) as pbar:  # # 使用tqdm查看训练的进度
...
if __name__ == '__main__':
    ...
    per_epoch_num = len(train_data) / BATCH_SIZE  # #  总长度
    D = discriminator()
