...
from slu_sequence_model import SluMultitaskCnnLstm
...
def run_slu_sequence_task(embedding_matrix, vocabulary, label_binarizer,
    ...
    # load model
    model = SluMultitaskCnnLstm(params, embedding_matrix, len(vocabulary), y_shapes)
...
def main(argv):
    ...
    run_slu_sequence_task(embedding_matrix, vocabulary, label_binarizer_sa,
