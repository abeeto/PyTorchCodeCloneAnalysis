...
from my_class import MyDataset, Net, DropoutFC, CCNet, DDNet, VGGNet, validate, show_confMat
...
max_dataset = True
if max_dataset:
    train_txt_path = './Data/MaxData/train.txt'
    valid_txt_path = './Data/MaxData/valid.txt'
    test_txt_path = './Data/MaxData/test.txt'
    mean_data_path = './Data/MaxData/mean_data.txt'
else:
    train_txt_path = './Data/MinData/train.txt'
    valid_txt_path = './Data/MinData/valid.txt'
    test_txt_path = './Data/MinData/test.txt'
    mean_data_path = './Data/MinData/mean_data.txt'
...
pretrained_model_path = './Result/01-15_15-16-59/net_params.pkl'
...
for epoch in range(max_epoch):
    ...
    print("Training: Epoch[{:0>3}/{:0>3}] Loss_Avg_Epoch: {:.4f} Acc_Avg_Epoch:{:.2%} Lr: {:.8f} Time: {:.2f}".format(
        epoch + 1, max_epoch, loss_avg_epoch, acc_avg_epoch, lr_now, during_time))
...
conf_mat_test, test_acc = validate(net, test_loader, 'test', classes_name)
