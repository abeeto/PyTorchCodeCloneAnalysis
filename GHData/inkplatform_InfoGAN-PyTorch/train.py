...
writer_real = SummaryWriter('results/{}/real_results'.format(params['dataset']))
writer_fake = SummaryWriter('results/{}/fake_results'.format(params['dataset']))
writer_graph = SummaryWriter('results/{}/graph_results'.format(params['dataset']))
writer_scalar = SummaryWriter('results/{}/scalar_results'.format(params['dataset']))
...
writer_real.add_image(params['dataset'] + 'Real Images', img_grid_real)
...
for epoch in range(params['num_epochs']):
    ...
    for i, (data, _) in enumerate(dataloader, 0):
        ...
        writer_graph.add_graph(netG, (noise,))

        output2 = discriminator(fake_data.detach())
        writer_graph.add_graph(discriminator,(fake_data,))
        probs_fake = netD(output2).view(-1)
        writer_graph.add_graph(netD, (output1,))
        ...
        #writer_scalar.add_scalars('',)
        writer_scalar.add_scalars('losses_%d_{}'.format(params['dataset']),
    ...
    writer_fake.add_image(params['dataset'] + 'Fake Images', img_grid_fake)
