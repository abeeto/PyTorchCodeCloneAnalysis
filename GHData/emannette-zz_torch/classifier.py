# use torchvision for visual datasets
import torch
import torchvision
...
Use the neural network defined in the neuralNet.py file.
modify it to take 3-channel images (instead of the 1-channel images)
'''
class Net(nn.Module):
...
# Train the network
# loop over data iterator -> feed the inputs to the network -> optimize
for epoch in range(2): # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if i % 2000 == 1999: # print ever 2000 mini-batches
            print('[%d, %5d] loss: %.3f' %
