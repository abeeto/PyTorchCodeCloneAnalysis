...
import converter
import ghost_net
import original_tf.ghost_net as tf_ghost_net
...
if __name__ == '__main__':
    ...
    with slim.arg_scope(tf_ghost_net.training_scope(is_training=False)):
        if model_name == 'large':
