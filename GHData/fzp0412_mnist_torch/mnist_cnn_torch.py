...
class Net(nn.Module):
    def __init__(self,hide1_num,hide2_num,class_num):
        super(Net,self).__init__()
        self.conv1 = nn.Sequential(
                        nn.Conv2d(1,filter1_size,kernel_size=3),
        ...
        self.layer4 = nn.Linear(hide2_num,class_num)
...
model = Net(hide1_num,hide2_num,class_num)
