...
if __name__ == '__main__':
    ...
    path = '/home/xian/dataset/hymenoptera/'
    candidate = ['bees', 'ants']
    label = []
    inputs = []
    ...
    for species in candidate:
        ...
        filenames = []
        if (species == 'bees'):
            filenames = os.listdir(r'/home/xian/dataset/hymenoptera/bees/')
            label = label + [309] * len(filenames)
        else:
            filenames = os.listdir(r'/home/xian/dataset/hymenoptera/ants/')
