...
class UnnormMVGaussian(Distribution):
    r"""
    Creates un-normalized multivariate normal (also called Gaussian) distribution
    ...
    def __init__(self, loc, covariance_matrix=None, precision_matrix=None, scale_tril=None, validate_args=None):
        ...
        super(UnnormMVGaussian, self).__init__(batch_shape, event_shape, validate_args=validate_args)
    ...
    def expand(self, batch_shape, _instance=None):
        new = self._get_checked_instance(UnnormMVGaussian, _instance)
        ...
        super(UnnormMVGaussian, new).__init__(batch_shape,
                                                self.event_shape,
                                                validate_args=False)
    ...
    def log_prob(self, value):
        ...
        return -0.5 * M + self.normalizing_constant
