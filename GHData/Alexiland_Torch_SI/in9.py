...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        file_train = open("/home/hg31/work/Torch_SI/csv/CIAR10_" +
                          str(9) + ".train_rndCropFlip.SI.train" + ".csv", "a")
        file_test = open("/home/hg31/work/Torch_SI/csv/CIAR10_" + str(
            9) + ".test.SI.test" + ".csv", "a")
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, file_train, args.s)
...
def train(train_loader, model, criterion, optimizer, epoch, file, sparsity=0):
