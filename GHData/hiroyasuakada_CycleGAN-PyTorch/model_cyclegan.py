...
class CycleGAN(object):
    ...
    def backward_G(self, real_A, real_B):
        ...
        return loss_G_A.data, loss_G_B.data, loss_cycle_A.data, loss_cycle_B.data, \
               loss_idt_A.data, loss_idt_B.data, fake_A.data, fake_B.data
    ...
    def optimize(self):
        ...
        loss_G_A, loss_G_B, loss_cycle_A, loss_cycle_B, loss_idt_A, loss_idt_B, fake_A, fake_B \
            = self.backward_G(self.real_A, self.real_B)
