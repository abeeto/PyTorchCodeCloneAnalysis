...
def get_opt():
    ...
    parser.add_argument("--dataroot_sketch", type=str, default='data/sketch', help="root to the sketch dataset")
    parser.add_argument("--dataroot_image", type=str, default='data/image', help="root to the image dataset for image regularization")
    parser.add_argument("--eval_dir", type=str, default='data/image', help="directory to the evaluation set")
    ...
    parser.add_argument("--no_wandb", default=True, help="use this flag to disable wandb visualization")
    parser.add_argument("--no_html", action="store_true", help="use this flag to disable html visualization")
    parser.add_argument('--display_winsize', type=int, default=400, help='display window size')
    parser.add_argument("--print_freq", type=int, default=1, help="frequency to print out current logs in stdout")
    parser.add_argument("--display_freq", type=int, default=10, help="frequency to display visualizations")
    parser.add_argument("--save_freq", type=int, default=10, help="frequency to save model checkpoints")
    parser.add_argument("--eval_freq", type=int, default=5000, help="frequency to evaluate current results")
    parser.add_argument("--disable_eval", default=True, help="use this flag to disable evaluation during training")
    parser.add_argument("--eval_batch", type=int, default=50, help="batch size used to generate images for evaluation")
    parser.add_argument("--reduce_visuals", default=True, help="use this flag to reduce amount of visualization (useful in the FFHQ case to reduce memory usage)")
    ...
    parser.add_argument("--max_iter", type=int, default=300, help="which iteration to stop training")
    parser.add_argument("--max_epoch", type=int, default=10+1, help="max number of training epoch")
    parser.add_argument("--iter_per_epoch", type=int, default=1, help="iter in each epoch")
    ...
    parser.add_argument("--g_pretrained", type=str, default="pretrained/stylegan2-cat/netG.pth", help="path to the pre-trained generator")
    ...
    parser.add_argument("--l_image", type=float, default=0.7, help="strength of image regularization loss")
    parser.add_argument("--l_weight", type=float, default=0, help="strength of weight regularization loss")#G reg!!
    parser.add_argument("--no_d_regularize", default=True, help="use this flag to disable R1 regularization")
    parser.add_argument("--d_reg_every", type=int, default=1, help="frequency to apply R1 regularization")
    parser.add_argument("--r1", type=float, default=1, help="strength of R1 regularzation")
