...
def readText():
    ...
    inputs = open('data/question2.txt', encoding='utf-8').read().strip().split('\n')
    outputs = open('data/answer2.txt', encoding='utf-8').read().strip().split('\n')
...
trainIters(encoder1, attn_decoder1, 7500, print_every=10)
...
torch.save(encoder1.state_dict(), 'data/rnne.pth')
torch.save(attn_decoder1.state_dict(), 'data/rnnd.pth')
