...
def train(args):
    ...
    if args.cuda:
        transformer.cpu()
    save_model_filename = "epoc_" + str(args.epochs) + "_" + str(time.ctime()).replace(' ', '_') + "_" + str()
...
def main():
    ...
    train_arg_parser.add_argument("--dataset", type=str, require=True,
    ...
    train_arg_parser.add_argument("--image-size", tpe=int, default=256,
                                  help="size of training images, default is 256 X 256")
    train_arg_parser.add_argument("--style-size", type=int, default=None,
                                  help="size of style-image, default is the original size of style image")
    train_arg_parser.add_argument("--cuda", type=int, require=True,
    ...
    train_arg_parser.add_argument("--checkpoint-interval", type=int, default=2000,
                                  help="number of batchs after which a checkpoint of the trained model will be created")
    
    eval_arg_parser = subparsers.add_parser("eval", help="parser for evaluation/stylizing arguments")
    eval_arg_parser.add_argument("--content-image", type=str, require=True,
