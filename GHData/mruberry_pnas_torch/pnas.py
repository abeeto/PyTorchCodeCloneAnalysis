...
# Constructs a PNASNet-5 model
# The model expects RGB images input as a 4D tensor:
#   batch size x channels (3) x height (331) x width (331)
# The tensor's values should be between 0 and 1 with mean and std deviation
#   of 0.5.
# NOTE: the original implementation of this model was designed for either
#   1000 or 1001 classes, but can handle any number
