...
data_file = "driving_log_track_1_full_relative_cleaned.csv"
...
prepare_batch_X = torch.tensor(prepare_batch_X, dtype=torch.float).view(-1,1,40,80)/255.0
