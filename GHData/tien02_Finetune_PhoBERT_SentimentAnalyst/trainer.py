...
dataset = UIT_VFSC_Dataset(root_dir=train_config.TRAIN_PATH)
...
class PhoBERTModel(LightningModule):
    def __init__(self, model):
        ...
        self.precision_fn = Precision(threshold=train_config.THRESHOLD)
        self.recall_fn = Recall(threshold=train_config.THRESHOLD)
