...
def test():
    data = UIT_VFSC_Dataset(root_dir=train_config.TRAIN_PATH, label=train_config.LABEL)
    dataloader = DataLoader(dataset=data, shuffle=False, collate_fn=collate_fn, batch_size=train_config.BATCH_SIZE)
