...
def get_args():
    parser = argparse.ArgumentParser("GearNetV1")
    ...
    parser.add_argument('--learning-rate', type=float, default=0.4, help='init learning rate')
    ...
    parser.add_argument('--val-interval', type=int, default=5000, help='val interval')
    ...
    parser.add_argument('--act', type=str, default='relu', choices=['relu', 'relu6', 'hs'], help='activation of the model')
