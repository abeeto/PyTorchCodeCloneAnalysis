...
from scipy.misc import imresize  # 在1.3这个版本中已经弃用imresize，故改为使用pillow的写法（11月14日）
...
class RandomScaleCrop(object):
    ...
    def __call__(self, images, intrinsics):
        ...
        #scaled_images = [np.array(Image.fromarray(im).resize((scaled_h, scaled_w))) for im in images]
